    ...
    static async medicamentoNome(req: Request, res: Response): Promise<Response> {
        try {
           ...
           if(nome == null) {
            ...
            if (respostaModelo == null) {
                return res.status(200).json({ mensagem: "Nenhum medicamento encontrado com o nome informado." });
            }
        ...
        try {
           ...
           if(principioAtivo == null) {
            ...
            if (respostaModelo == null) {
                return res.status(200).json({ mensagem: "Nenhum medicamento encontrado com o princípio ativo informado." });
            }
            return res.status(200).json(respostaModelo);
        } catch (error) {
